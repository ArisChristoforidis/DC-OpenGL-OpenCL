...
/*
//TODO:Add description.
double NoiseUtils::SimplexNoise2(double x, double y, double z) {
	...
	int gi2 = permMod12[ii + i1 + perm[jj + j2 + perm[kk + k2]]];
	int gi3 = permMod12[ii + i1 + perm[jj + 1 + perm[kk + 1]]];
	...
	return FREQUENCY * 32.0*(n0 + n1 + n2 + n3);

}

void NoiseUtils::InitTables() {
	for (int i = 0; i < 512; i++) {
		perm[i] = p[i & 255];
